                            ...
                            <FormLabel className="account-form_image-label">
                                {
                                    field.value ? (
                                        ...
                                        <Image src={'/assets/profile.svg'} alt="profile photo" width={24} height={24} priority className="rounded-full object-contain" />
                                    )
                                }
                            </FormLabel>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-col gap-3 w-full">
                            ...
                            <FormControl >
                                <Textarea rows={10} placeholder="bio" className=" account-form_input no-focus" {...field} />
                            </FormControl>
